...
def solve_standard_form(equation_str, target_var_str):
    """Calculates the answer using Deterministic Standard Form Isolation (Ax + B = 0)."""
    steps = []
    try:
        ...
        steps.append(("text", "METHOD: Deterministic Algorithmic Isolation (Standard Form)\n"))
        ...
        # EARLY VALIDATION: Check if the user forgot to type the variable entirely
